...
class OverallSumsTrackerTest {
    ...
    private static final Payment FIXED_PAYMENT_MORTGAGE = new Payment(1L, "House", Category.MORTGAGE, PaymentType.FIXED, 1000D, LocalDate.now());
    private static final Payment DAILY_PAYMENT_FOOD = new Payment(1L, "Food", Category.FOOD, PaymentType.DAILY, 12.3D, LocalDate.now());
    private static final Payment LEISURE_PAYMENT_MUSIC = new Payment(1L, "Music", Category.MEDIA, PaymentType.LEISURE, 44.9D, LocalDate.now());
    private static final Payment SAVING_PAYMENT_ETF = new Payment(1L, "Etf", Category.ETF, PaymentType.SAVING, 150D, LocalDate.now());
