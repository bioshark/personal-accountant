...
public class MonthlyExpenses {
    ...
    public MonthlyExpenses(LocalDate startDate, YearMonth yearMonth) {
        ...
        this.incomes.registerListener(overallSumsTracker);
    ...
    public Map<LocalDate, List<BaseTransaction>> getPayments() {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(payments, that.payments) && Objects.equals(startDate, that.startDate) && incomes.equals(
